...
# Scheduled 1 strats onto 1 cores with 30 seconds (30 total)
# Starting G-E--_302_C18_F1_URBAN_RG_S04BN with 30s (1) cores
# G-E--_302_C18_F1_URBAN_RG_S04BN with pid 13207 completed with status 0
...
# Starting SAT001_MinMin_p005000_rr_RG with 17s (1) cores
# SAT001_MinMin_p005000_rr_RG with pid 13209 completed with status 0
...
tff(conj_0, conjecture, ![X1:a]:((~(p(X1))|p(X1))), file('/Users/linqilan/Downloads/KEP AWS/sledgehammer_export/prob4876858_min_1.p', conj_0)).
