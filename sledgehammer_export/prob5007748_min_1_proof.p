...
% dis+1002_1:1_bd=off:fd=off:sos=on:i=601:si=on:rtra=on_0 on prob5007748_min_1 for (3ds)
% Refutation found. Thanks to Tanya!
% SZS status Theorem for prob5007748_min_1
% SZS output start Proof for prob5007748_min_1
...
tff(f1,conjecture,(
  ! [X0 : a] : (p(X0) | ~p(X0))),
  file('/Users/linqilan/Downloads/KEP AWS/sledgehammer_export/prob5007748_min_1.p',conj_0)).
tff(f7,plain,(
  p(sK0)),
  inference(cnf_transformation,[],[f5])).
% SZS output end Proof for prob5007748_min_1
% ------------------------------
