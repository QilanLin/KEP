...
% dis+1002_1:1_bd=off:fd=off:sos=on:i=601:si=on:rtra=on_0 on prob4736116_1 for (3ds)
...
% WARNING: time unlimited strategy and instruction limiting not in place - attemping to translate instructions to time
% WARNING: option i not known.
% ott+1010_8:1_bsr=unit_only:drc=off:fsr=off:plsq=on:plsqc=1:plsqr=32,1:s2a=on:s2agt=32:urr=on:i=894:si=on:rtra=on_0 on prob4736116_1 for (4ds)
% Refutation not found, incomplete strategy
% ------------------------------
% Version: Vampire 4.8 HO - Sledgehammer schedules (2023-10-19)
% Termination reason: Refutation not found, incomplete strategy
...
% WARNING: time unlimited strategy and instruction limiting not in place - attemping to translate instructions to time
% WARNING: option i not known.
% dis+1011_4:1_av=off:nwc=10.0:sd=1:sgt=16:ss=axioms:i=563:si=on:rtra=on_0 on prob4736116_1 for (2ds)
% SZS status CounterSatisfiable for prob4736116_1
% # SZS output start Saturation.
cnf(u8,negated_conjecture,
    x != plus_plus_a(x,zero_zero_a)).
